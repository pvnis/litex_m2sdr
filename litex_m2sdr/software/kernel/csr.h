//--------------------------------------------------------------------------------
// Auto-generated by LiteX (e2625f98d) on 2026-03-27 11:06:56
//--------------------------------------------------------------------------------
...
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_CONTROL_ADDR 0x6044L
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_CONTROL_SIZE 1
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_STATUS_ADDR 0x6048L
#define CSR_PCIE_DMA0_BUFFERING_READER_FIFO_STATUS_SIZE 1
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_CONTROL_ADDR 0x604cL
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_CONTROL_SIZE 1
#define CSR_PCIE_DMA0_BUFFERING_WRITER_FIFO_STATUS_ADDR 0x6050L
...
#define CSR_CAPABILITY_FEATURES_TIMED_TX_OFFSET 6
#define CSR_CAPABILITY_FEATURES_TIMED_TX_SIZE 1
#define CSR_CAPABILITY_FEATURES_TDD_OFFSET 7
#define CSR_CAPABILITY_FEATURES_TDD_SIZE 1
#define CSR_CAPABILITY_FEATURES_CFR_OFFSET 8
#define CSR_CAPABILITY_FEATURES_CFR_SIZE 1
#define CSR_CAPABILITY_FEATURES_IQ_CORRECTION_OFFSET 9
#define CSR_CAPABILITY_FEATURES_IQ_CORRECTION_SIZE 1
#define CSR_CAPABILITY_FEATURES_DC_FILTER_OFFSET 10
#define CSR_CAPABILITY_FEATURES_DC_FILTER_SIZE 1
#define CSR_CAPABILITY_FEATURES_RFIC_OVERSAMPLING_OFFSET 11
...
/* CFR Registers */
#define CSR_CFR_BASE 0xb000L
#define CSR_CFR_ENABLE_ADDR 0xb000L
#define CSR_CFR_ENABLE_SIZE 1
#define CSR_CFR_THRESHOLD_ADDR 0xb004L
#define CSR_CFR_THRESHOLD_SIZE 1
#define CSR_CFR_CLIP_COUNT_ADDR 0xb008L
#define CSR_CFR_CLIP_COUNT_SIZE 1
...
#define CSR_HEADER_TS_MODE_ADDR 0xb810L
#define CSR_HEADER_TS_MODE_SIZE 1
#define CSR_HEADER_LAST_TX_HEADER_ADDR 0xb814L
#define CSR_HEADER_LAST_TX_HEADER_SIZE 2
#define CSR_HEADER_LAST_TX_TIMESTAMP_ADDR 0xb81cL
#define CSR_HEADER_LAST_TX_TIMESTAMP_SIZE 2
#define CSR_HEADER_LAST_TX_FLAGS_ADDR 0xb824L
#define CSR_HEADER_LAST_TX_FLAGS_SIZE 1
#define CSR_HEADER_LAST_RX_HEADER_ADDR 0xb828L
#define CSR_HEADER_LAST_RX_HEADER_SIZE 2
#define CSR_HEADER_LAST_RX_TIMESTAMP_ADDR 0xb830L
...
#define CSR_HEADER_TS_MODE_MODE_OFFSET 0
#define CSR_HEADER_TS_MODE_MODE_SIZE 1
...
/* TIMED_TX Registers */
#define CSR_TIMED_TX_BASE 0x12800L
#define CSR_TIMED_TX_ENABLE_ADDR 0x12800L
#define CSR_TIMED_TX_ENABLE_SIZE 1
#define CSR_TIMED_TX_LATE_COUNT_ADDR 0x12804L
#define CSR_TIMED_TX_LATE_COUNT_SIZE 1
#define CSR_TIMED_TX_UNDERRUN_COUNT_ADDR 0x12808L
#define CSR_TIMED_TX_UNDERRUN_COUNT_SIZE 1
#define CSR_TIMED_TX_STATE_ADDR 0x1280cL
#define CSR_TIMED_TX_STATE_SIZE 1
#define CSR_TIMED_TX_ARMED_TS_ADDR 0x12810L
#define CSR_TIMED_TX_ARMED_TS_SIZE 2
#define CSR_TIMED_TX_ARMED_HAS_TIME_ADDR 0x12818L
#define CSR_TIMED_TX_ARMED_HAS_TIME_SIZE 1
#define CSR_TIMED_TX_TS_POP_COUNT_ADDR 0x1281cL
#define CSR_TIMED_TX_TS_POP_COUNT_SIZE 1
#define CSR_TIMED_TX_LAST_LATE_TS_ADDR 0x12820L
#define CSR_TIMED_TX_LAST_LATE_TS_SIZE 2
#define CSR_TIMED_TX_LAST_LATE_TIME_ADDR 0x12828L
#define CSR_TIMED_TX_LAST_LATE_TIME_SIZE 2
#define CSR_TIMED_TX_LAST_LATE_HAS_TIME_ADDR 0x12830L
#define CSR_TIMED_TX_LAST_LATE_HAS_TIME_SIZE 1
#define CSR_TIMED_TX_LAST_LATE_TS_POP_ADDR 0x12834L
#define CSR_TIMED_TX_LAST_LATE_TS_POP_SIZE 1
#define CSR_TIMED_TX_LAST_LATE_STATE_ADDR 0x12838L
#define CSR_TIMED_TX_LAST_LATE_STATE_SIZE 1
#define CSR_TIMED_TX_RESET_COUNTS_ADDR 0x1283cL
#define CSR_TIMED_TX_RESET_COUNTS_SIZE 1
#define CSR_TIMED_TX_GAP_FILL_ADDR 0x12840L
#define CSR_TIMED_TX_GAP_FILL_SIZE 1

/* TIMED_TX Fields */

/* SAMPLE_COUNTER Registers */
#define CSR_SAMPLE_COUNTER_BASE 0x13000L
#define CSR_SAMPLE_COUNTER_CONTROL_ADDR 0x13000L
#define CSR_SAMPLE_COUNTER_CONTROL_SIZE 1
#define CSR_SAMPLE_COUNTER_COUNT_ADDR 0x13004L
#define CSR_SAMPLE_COUNTER_COUNT_SIZE 2

/* SAMPLE_COUNTER Fields */
#define CSR_SAMPLE_COUNTER_CONTROL_READ_OFFSET 0
#define CSR_SAMPLE_COUNTER_CONTROL_READ_SIZE 1

/* ICAP_BITSTREAM Registers */
#define CSR_ICAP_BITSTREAM_BASE 0x13800L
#define CSR_ICAP_BITSTREAM_SINK_DATA_ADDR 0x13800L
#define CSR_ICAP_BITSTREAM_SINK_DATA_SIZE 1
#define CSR_ICAP_BITSTREAM_SINK_READY_ADDR 0x13804L
#define CSR_ICAP_BITSTREAM_SINK_READY_SIZE 1

/* ICAP_BITSTREAM Fields */

/* DC_FILTER Registers */
#define CSR_DC_FILTER_BASE 0x14000L
#define CSR_DC_FILTER_ENABLE_ADDR 0x14000L
#define CSR_DC_FILTER_ENABLE_SIZE 1
#define CSR_DC_FILTER_ALPHA_SHIFT_ADDR 0x14004L
#define CSR_DC_FILTER_ALPHA_SHIFT_SIZE 1

/* DC_FILTER Fields */

/* IQ_CORRECTION Registers */
#define CSR_IQ_CORRECTION_BASE 0x14800L
#define CSR_IQ_CORRECTION_ENABLE_ADDR 0x14800L
#define CSR_IQ_CORRECTION_ENABLE_SIZE 1
#define CSR_IQ_CORRECTION_CH_A_A_ADDR 0x14804L
#define CSR_IQ_CORRECTION_CH_A_A_SIZE 1
#define CSR_IQ_CORRECTION_CH_A_B_ADDR 0x14808L
#define CSR_IQ_CORRECTION_CH_A_B_SIZE 1
#define CSR_IQ_CORRECTION_CH_A_C_ADDR 0x1480cL
#define CSR_IQ_CORRECTION_CH_A_C_SIZE 1
#define CSR_IQ_CORRECTION_CH_A_D_ADDR 0x14810L
#define CSR_IQ_CORRECTION_CH_A_D_SIZE 1
#define CSR_IQ_CORRECTION_CH_B_A_ADDR 0x14814L
#define CSR_IQ_CORRECTION_CH_B_A_SIZE 1
#define CSR_IQ_CORRECTION_CH_B_B_ADDR 0x14818L
#define CSR_IQ_CORRECTION_CH_B_B_SIZE 1
#define CSR_IQ_CORRECTION_CH_B_C_ADDR 0x1481cL
#define CSR_IQ_CORRECTION_CH_B_C_SIZE 1
#define CSR_IQ_CORRECTION_CH_B_D_ADDR 0x14820L
#define CSR_IQ_CORRECTION_CH_B_D_SIZE 1

/* IQ_CORRECTION Fields */
