...
setsid sudo -n env \
    ...
    M2SDR_SOAPY_TX_RMS_LOG_LIMIT="${M2SDR_SOAPY_TX_RMS_LOG_LIMIT:-16}" \
    M2SDR_SOAPY_TX_TIME_OFFSET_NS="${M2SDR_SOAPY_TX_TIME_OFFSET_NS:-0}" \
    M2SDR_SOAPY_TX_COPY_PRIME_BUFFERS="${M2SDR_SOAPY_TX_COPY_PRIME_BUFFERS:-8}" \
    M2SDR_SOAPY_TX_DMA_DUMP_PATH="${M2SDR_SOAPY_TX_DMA_DUMP_PATH:-}" \
    M2SDR_SOAPY_TX_DMA_DUMP_BUFFERS="${M2SDR_SOAPY_TX_DMA_DUMP_BUFFERS:-16}" \
    M2SDR_SOAPY_TX_IDLE_FILL="${M2SDR_SOAPY_TX_IDLE_FILL:-0}" \
    M2SDR_SOAPY_TX_DEDUP_TIME="${M2SDR_SOAPY_TX_DEDUP_TIME:-1}" \
    M2SDR_SOAPY_TX_CS16_TO_SC12="${M2SDR_SOAPY_TX_CS16_TO_SC12:-0}" \
    M2SDR_SOAPY_TX_SLIP_TRACE="${M2SDR_SOAPY_TX_SLIP_TRACE:-0}" \
    M2SDR_SOAPY_TX_SLIP_TRACE_LIMIT="${M2SDR_SOAPY_TX_SLIP_TRACE_LIMIT:-64}" \
    "$OCUDU_GNB_BIN" -c "$RUN_DIR/gnb-run.yml" < /dev/null > "$RUN_DIR/gnb.log" 2>&1 &
